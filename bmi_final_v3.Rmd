...
plot(1:20, best_subsets[, "cp"], xlab="No. of predictor", ylab="Cp Statistic")
abline(0,1)

plot(1:20, best_subsets[, "adjr2"], xlab="No. of predictor", ylab="Adj R2")
```

1. The criterion-based model is
```{r}
